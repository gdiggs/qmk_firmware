...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [BASE] = LAYOUT_60_ansi(
	  ...
	  CAPS_CTL,  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, KC_ENT,
		...
		KC_LCTL,   KC_LGUI, KC_LALT,                   FN_SPACE,                  KC_RALT, KC_RCTL, KC_LGUI, MO(1)
  ),
  ...
  [_FN2] = LAYOUT_60_ansi(
		TR_TICK,   _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
